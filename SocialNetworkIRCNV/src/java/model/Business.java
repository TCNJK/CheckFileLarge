...
public class Business {
    private String BusinessID, UserID, BrandName, 
            Address, Mail, PhoneNumber, ImageAvatar,
            ImageBackGround;
    private int NumFlow;
    ...
    public Business(String BusinessID, String UserID, String BrandName, String Address, String Mail, String PhoneNumber, String ImageAvatar, String ImageBackGround, int NumFlow, String intro, float budget, String TimeCreate) {
    ...
    public int getNumFlow() {
        return NumFlow;
    }

    public void setNumFlow(int NumFlow) {
        this.NumFlow = NumFlow;
    }
