...
<html>
    ...
    <body style="margin: 0">
        ...
        <div class ="profile-container">
            <img src="<%=business.getImageBackGround()%>" class="cover-img"/>
            <div class = "profile-details">
                <div class ="pd-left">
                    <div class ="pd-row">
                        <img src ="<%=business.getImageAvatar()%>" class ="pd-image">
                        <div>
                            <h3><a href="" style="text-decoration: none; color:#626262;"><%=business.getBrandName()%></a></h3>
                            <p>number flowers</p>
                        </div>
                    </div>
                </div>
                <div class = "pd-right" >
                    ...
                    <span class = "sendmessage">    
                        <a href="/SocialNetworkIRCNV/BoxChat/BoxChat.jsp?Friendid=<%=business.getUserID()%>">
                            <button type = "button"> 
                            <i class="icon fa-regular fa-message"></i> Send Message to Admin
                        </button>
                        </a>
            ...
            <div class ="profile-info">
                <div class ="info-col">
                    <div class ="profile-intro">
                        <h3>Intro</h3>
                        <p class = "intro-text"><%=business.getIntro()%></p>
                        <hr>
                        <ul>
                            <li><i class="intro fa-solid fa-house" style="width: 26px;  margin: 0" ></i>Lives in  <span style="margin-right: 5px;"></span><strong><%=business.getAddress()%></strong></li>
                            <li><i class="intro fa-solid fa-location-dot" style="width: 26px; margin: 0"></i>From  <span style="margin-right: 5px;"></span><strong><%=business.getPhoneNumber()%></strong></li>
                        </ul>
                    </div>
                    <div class = "profile-intro">
                        <div class ="title-box">
                                    ...
                                    <form action="/SocialNetworkIRCNV/UpdateInfo" method = "post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <img id="previewImage4" src="<%=user.getImgUser()%>" alt="Preview Image" style="width: 130px;
                                                                                                                            ...
                                                                                                                            border-radius: 3px;
                                                                                                                            object-fit: cover;">
                                            <input  type="file" accept="image,gif/*,capture=camera" name="avatar" id="fileInput4">
                                        </div>
